...
public class DataCenter {
    ...
    public void getOperatorById(Context context, long id) {
        Operator operatorById = networkClient.getOperatorById(id);
        //TODO merge new and old operator @Nam
    ...
    public void getSessionById(Context context, long id) {
        ...
        //TODO compare new and old session to save to database @Nam
    }
...
//		db.put(key, session);
    ...
    public void getAuditItemById(Context context, long id) {
        AuditItem auditItemById = networkClient.getAuditItemById(id);
        //TODO compare new audit Item and old in database @Nam
    }
