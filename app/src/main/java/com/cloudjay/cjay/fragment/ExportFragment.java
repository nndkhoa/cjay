...
public class ExportFragment extends Fragment {
	...
	void setUp() {
		...
		try {
			dataCenter.getGateImages(getActivity().getApplicationContext(), CJayConstant.TYPE_IMPORT, containerID);
		...
		try {
			dataCenter.getGateImages(getActivity().getApplicationContext(), CJayConstant.TYPE_EXPORT, containerID);
		} catch (SnappydbException e) {
			e.printStackTrace();
		}

		// Get audit and repaired images by containerId
		dataCenter.getAuditImages(getActivity().getApplicationContext(), containerID);
	}
