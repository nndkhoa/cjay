...
public class BindDictionary<T> {
	...
	// Image field methods
	// ---------------
	public DynamicImageField<T> addDynamicImageField(int viewResId,
			StringExtractor<T> extractor, DynamicImageLoader dynamicImageLoader) {

		DynamicImageField<T> field = new DynamicImageField<T>(viewResId,
				extractor, dynamicImageLoader);
	...
	public CheckableField<T> addCheckableField(int viewResId,
		...
		CheckableField<T> field = new CheckableField<T>(viewResId,
				isCheckedExtractor);
	...
	public StaticImageField<T> addStaticImageField(int viewResId,
		...
		StaticImageField<T> field = new StaticImageField<T>(viewResId,
				staticImageLoader);
