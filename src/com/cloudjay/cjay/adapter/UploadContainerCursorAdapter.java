...
public class UploadContainerCursorAdapter extends CursorAdapter implements Filterable {
	...
	public UploadContainerCursorAdapter(Context context, Cursor c) {
		super(context, c);
	}

	public UploadContainerCursorAdapter(Context context, int layout, Cursor c, int flags) {
