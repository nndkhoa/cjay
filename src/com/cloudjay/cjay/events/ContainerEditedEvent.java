...
public class ContainerEditedEvent {

	private final List<ContainerSession> listContainerSessions;

	public ContainerEditedEvent(List<ContainerSession> containerSessions) {
		listContainerSessions = containerSessions;
	}

	public ContainerEditedEvent(ContainerSession containerSession) {
