...
public class RepairContainerFixedListFragment extends SherlockFragment implements OnRefreshListener,
	...
	public Loader<Cursor> onCreateLoader(int arg0, Bundle arg1) {
		...
		return new CJayCursorLoader(context) {
			...
			public Cursor loadInBackground() {
				Cursor cursor = DataCenter.getInstance().getFixedContainerSessionCursor(getContext());
		...
		if (cursorAdapter == null) {
			...
			cursorAdapter.setFilterQueryProvider(new FilterQueryProvider() {
				...
				public Cursor runQuery(CharSequence constraint) {
					return DataCenter.getInstance().filterFixedCursor(getActivity(), constraint);
				}
			});
