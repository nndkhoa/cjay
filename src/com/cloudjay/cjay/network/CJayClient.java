...
//		HashMap<String, String> headers = prepareHeadersWithToken(ctx);
//		String formatStr = "https://cloudjay-web.appspot.com/api/jaypix/jaypix-items-by-team?team_id=%s&page=%s";
...
//
//	@Override
//	public UserModel getCurrentUser(String token, Context ctx) {
//		HashMap<String, String> headers = new HashMap<String, String>();
//
//		headers.put("Authorization", "Token " + token);
//		String response = requestWrapper.sendGet(
//				"https://cloudjay-web.appspot.com/api/jaypix/current-user",
//				headers);
//
//		Gson gson = new Gson();
//		Type userType = new TypeToken<UserModel>() {
//		}.getType();
//		UserModel user = gson.fromJson(response, userType);
//		return user;
//	}
//
//	@Override
...
//			String url = "https://cloudjay-web.appspot.com/api/jaypix/jaypix-users-by-team.json?team_id="
//					+ teamModel.getId();
//			String response = requestWrapper.sendGet(url, headers);
//			Gson gson = new Gson();
...
//
//	@Override
//	public ItemModel getItemModel(Context ctx, UserModel currentUser, int itemId) {
